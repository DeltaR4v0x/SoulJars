...
public class SoulJars extends JavaPlugin implements Listener, SlimefunAddon {
    ...
    public void onEnable() {
        ...
        itemGroup = new ItemGroup(new NamespacedKey(this, "soul_jars"), CustomItemStack.create(PlayerHead.getItemStack(PlayerSkin.fromHashCode(JAR_TEXTURE)), "&bSoul Jars", "", "&a> Click to open"));
